...
Of course, with a 1-dimensional array of buttons, and a single strum bar, it's nearly impossible to mimic playing the actual song, but there are certain mechanics implemented in the game to make it feel more natural.
