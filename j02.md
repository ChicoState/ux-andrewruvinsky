# [Andrew's UX Portfolio](README.md)
...
I began playing Guitar Hero before I started playing the real guitar, so the mechanics mentioned above were foreign and took me while to learn. Guitar Hero doesn't make these mechanics clear before you jump into your first level, which forces the player to try to figure it out on their own. However there is a tutorial section of the game where you can learn these tactics.
